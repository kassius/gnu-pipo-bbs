 ...
 *
 *---------------------------------------------------------------------
 *  "Emu.java": Applet for VT102 terminal emulation and communication
 *              with the Pipo-BBS server.
 *
...
public class Emu extends JApplet {
    public void init() {
        try {
            Socket server = new Socket(getCodeBase().getHost(), getCodeBase().getPort());
        ...
        System.out.println("Connected to Pipo-BBS server...");
    }
}
